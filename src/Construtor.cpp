...
int tamanhoVetor = instancia->get_m()*0.4;
...
this->lista->Remove_na_Lista(maquinas_mais_devagar2[j],(this->instancia->get_m()-j)*importanciaVelocidade);
//this->lista->Imprime();
this->lista->Remove_na_Lista(maquinas_com_maior_makespam2[j],(this->instancia->get_m()-j)*importanciaMakespam);
this->lista->Remove_na_Lista(maquinas_com_maior_consumo2[j],((this->instancia->get_m()-j))*importanciaConsumo);
this->lista->Remove_na_Lista(maquinas_com_maior_gasto2[j],((this->instancia->get_m()-j))*importanciaGasto);
...
for(int j=0;j<tamanhoVetor;j++){
this->lista->Adicionar_na_Lista(maquinas_mais_rapidas2[j],(this->instancia->get_m()-j)*importanciaVelocidade);
this->lista->Adicionar_na_Lista(maquinas_com_menos_makespam2[j],(this->instancia->get_m()-j)*importanciaMakespam);
this->lista->Adicionar_na_Lista(maquinas_com_menos_consumo2[j],((this->instancia->get_m()-j))*importanciaConsumo);
this->lista->Adicionar_na_Lista(maquinas_com_menos_gasto2[j],((this->instancia->get_m()-j))*importanciaGasto);
}
...
void Construtor::Calcular_media_Consumo_por_tempo(){
    ...
    for(Processo* processo=this->instancia->get_primeiro_Processo(); processo!=NULL ; processo=processo->get_prox_Processo()){//para todos processos

    for(int i=0;i<this->instancia->get_m();i++){//em todas as maquinas
...
int k;
    ...
    for(int i=this->instancia->calcInicioDia();i< (this->instancia->get_b()+this->instancia->calcInicioDia());i++){//para todos processos
